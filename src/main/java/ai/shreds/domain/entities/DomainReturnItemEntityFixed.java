...
public class DomainReturnItemEntityFixed {
    ...
    protected DomainReturnItemEntityFixed() {}

    // Constructor
    public DomainReturnItemEntityFixed(String orderItemId, String productId, Integer quantity, 
